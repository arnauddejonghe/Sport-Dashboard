  ...
  const data = {
    ...
    html() {
      return `<section class="card c6"><div class="card-h"><div><h2>Synchronisation Google Drive</h2><p class="sub">À chaque ouverture, le dashboard cherche tes nouveaux exports dans ton dossier de suivi.</p></div></div><div id="sync-page"></div>
          <p class="note">Fichiers reconnus : Health Export ou raccourci Apple Santé (.csv) ; MacroFactor (.xlsx) : export complet, rapide (7 derniers jours, avec le journal de séries et le RIR) ou granulaire ; TrainAI (.xlsx) ; feuille ou CSV « Journal… » / « Retours… » (colonnes Date, Note, Tags, Humeur, Énergie, Stress, Courbatures, Douleur &lt;zone&gt;, plusieurs lignes par jour possibles) ; rapports « AAAA-MM-JJ_coach.md » ; bilans « Bilan… » (Date;Marqueur;Valeur;Unité;Min;Max) ; photos dans le sous-dossier « Photos » (AAAA-MM-JJ_face.jpg, _profil, _dos), lues à la demande.</p></section>
